...
type DocumentsResponseType = InferResponseType<
    (typeof client.api.documents.transaction)[':transactionId']['$get'],
    200
>['data'];
        ...
        mutationFn: async ({
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    throw new Error(
                        `Failed to upload to Azure Storage (${response.status}): ${errorText}`,
                    );
                }
