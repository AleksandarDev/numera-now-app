...
export function ReconciliationSettingsCard() {
  ...
  const { data: documentTypes = [], isLoading: docTypesLoading } = useGetDocumentTypes();
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p>
                      Select which document types must be attached before a transaction 
              ...
              {documentTypes.map((docType) => (
                <div key={docType.id} className="flex items-center space-x-3">
                  <Checkbox
                    ...
                    checked={requiredDocTypeIds.includes(docType.id)}
                    onCheckedChange={() => toggleRequiredDocType(docType.id)}
                  />
                  <Label
            ...
            {requiredTypesCount === 0 && (
              <p className="text-sm text-muted-foreground">
                No required document types selected. Transactions can be reconciled without document verification.
              </p>
            )}
          </div>
        )}
        ...
        {requiredTypesCount > 0 && (
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <Label htmlFor="minRequiredDocs" className="font-medium">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p>
                      ...
                      before a transaction can be marked as &quot;Reconciled&quot;.
                    </p>
                    <p className="mt-2">
        ...
        {documentTypes.length === 0 && (
          <p className="text-sm text-muted-foreground">
            No document types available. Create document types in the Document Types section to configure reconciliation requirements.
          </p>
        )}
      </CardContent>
    </Card>
