...
ALTER TABLE "transactions" ADD COLUMN "credit_account_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "transactions" ADD COLUMN "debit_account_id" text NOT NULL;--> statement-breakpoint
